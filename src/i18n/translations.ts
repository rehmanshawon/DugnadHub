...
export const translations: Record<SupportedLanguage, Record<string, string>> = {
  en: {
    ...
    "login.title": "Welcome to DugnadHub!",
    "login.subtitle":
  ...
  no: {
    ...
    "login.errorInvalidCredentials": "Ugyldig e-post eller passord.",
    "login.errorTooManyRequests": "For mange forsøk. Prøv igjen senere.",
    "login.errorGeneric": "Noe gikk galt. Prøv igjen.",
